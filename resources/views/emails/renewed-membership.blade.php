...
<head>
    ...
    <title>Renovación Future Fit</title>
</head>
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                @foreach ($membershipInfo as $item)
                    <p><strong>Tipo de membresia:</strong> {{$item->type}}</p>
                    <p><strong>Plan:</strong> {{$item->plan}}</p>
                    <p><strong>Precio:</strong> ${{$item->price}}</p>
                    <p><strong>Proxima renovación:</strong> {{\Carbon\Carbon::parse($item->pivot->renew_date)->format('d-m-Y')}}</p>
                @endforeach
            </div>
        </div>
