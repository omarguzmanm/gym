...
<x-guest-layout>
    ...
    <div class="md:flex md:justify-center md:items-center lg:flex lg:justify-center lg:items-center h-screen lg:h-[80vh] border-t border-gray-300">
        <div class="custom-height sm:w-full md:w-2/3 lg:w-1/3 p-6 bg-white shadow shadow-xl">
                    ...
                    <div class="h-full flex flex-col justify-center items-center">
                        ...
                        <form class="w-full max-w-xs">
                            <div class="mb-4">
                                ...
                                <input type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-300 focus:border-orange-500 block w-full p-2.5">
                            </div>
                            <div class="mb-4">
                                <label for="password-input" class="block mb-2 text-sm font-bold text-gray-900">Contraseña</label>
                                <input type="password" id="password-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-300 focus:border-orange-500 block w-full p-2.5">
                            </div>
                            <div class="mb-4">
