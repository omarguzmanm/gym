...
<header class="container mx-auto py-4">
    <div class="mx-5">
        <img class="rounded-md" src="img/cover-membresias.jpg" alt="Inscribite ahora - Banner">
    </div>
</header>
<!-- FIn header app -->
...
<section>
  <div class="container mx-auto my-16">
    <div class="col-span-3 mb-5 text-center mx-5">
      <span class="text-2xl font-bold tracking-tight text-orange-500 ">CONOCE TODAS NUESTRAS MEMBRESIAS</span>
      <h2 class="text-4xl font-bold tracking-tight">ELIGE TU PLAN AHORA</h2>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-items-center">
        <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-xl hover:shadow-orange-500 sm:p-8 mx-5">
            ...
            <button onclick="location.href='{{route('checkout-form', $premiumMonthPrice)}}'" class="text-white bg-orange-400 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-200 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Unirme ahora</</button>
        </div>
      ...
      <button type="button" onclick="location.href='{{route('checkout-form', $classicMonthPrice)}}'" class="text-white bg-gray-500 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Unirme ahora</button>
  </div>
  <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-xl hover:shadow-gray-500 sm:p-8 mx-5">

    <h5 class="mb-4 text-xl font-medium text-gray-500">Plan Semanal</h5>
    <div class="flex items-baseline text-gray-900">
        <span class="text-3xl font-semibold">$</span>
        <span class="text-5xl font-extrabold tracking-tight">199</span>
        <span class="ml-1 text-xl font-normal text-gray-500">/semana</span>
    </div>
    <ul role="list" class="space-y-5 my-7">
        <li class="flex space-x-3 items-center">
            <svg class="flex-shrink-0 w-4 h-4 text-orange-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
    ...
    <button type="button" onclick="location.href='{{route('checkout-form', $weekPrice)}}'"  class="text-white bg-gray-500 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Unirme ahora</button>
  </div> 
  </div>
</div>
...
<section>
  <div class="container mx-auto my-20">
    <div class="col-span-3 mb-5 text-center">
        <span class="text-2xl font-bold tracking-tight text-orange-500 ">OTRAS MEMBRESIAS</span>
        <h2 class="text-4xl font-bold tracking-tight">APROVECHA LAS PROMOCIONES</h>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-items-center">
        <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-xl hover:shadow-gray-500 sm:p-8 mx-5">
            <h5 class="mb-4 text-xl font-medium text-gray-500">Plan Anual Classic</h5>
        <div class="flex items-baseline text-gray-900">
            <span class="text-3xl font-semibold">$</span>
            <span class="text-5xl font-extrabold tracking-tight">4,499</span>
    ...
    <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-xl hover:shadow-gray-500 sm:p-8 mx-5">
        <h5 class="mb-4 text-xl font-medium text-gray-500">Plan Semestral Classic</h5>
      <div class="flex items-baseline text-gray-900">
          <span class="text-3xl font-semibold">$</span>
          <span class="text-5xl font-extrabold tracking-tight">2,299</span>
          <span class="ml-1 text-xl font-normal text-gray-500">/semestre</span>
      </div>
      <ul role="list" class="space-y-5 my-7">
          <li class="flex space-x-3 items-center">
              <svg class="flex-shrink-0 w-4 h-4 text-orange-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
<section>
    <div class="container mx-auto my-20">
        <div class="col-span-3 mb-5 text-center">
            <span class="text-2xl font-bold tracking-tight text-orange-500 ">EXPLOTA TODO TU POTENCIAL</span>
            <h2 class="text-4xl font-bold tracking-tight">PLANES PREMIUM</h2>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-items-center">
            <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-xl hover:shadow-orange-500 sm:p-8 mx-5">
                <h5 class="mb-4 text-xl font-medium text-gray-500">Plan Anual Premium</h5>
                <div class="flex items-baseline text-gray-900">
                    <span class="text-3xl font-semibold">$</span>
    ...
    <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-xl hover:shadow-orange-500 sm:p-8 mx-5">
        <h5 class="mb-4 text-xl font-medium text-gray-500">Plan Semestral Premium</h5>
            <div class="flex items-baseline text-gray-900">
                <span class="text-3xl font-semibold">$</span>
            ...
            <button type="button" class="text-white bg-orange-400 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-200 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Unirme ahora</</button>  </div>
            <div class="max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-xl hover:shadow-orange-500 sm:p-8 mx-5">
                <h5 class="mb-4 text-xl font-medium text-gray-500">Plan Trimestral Premium</h5>
            <div class="flex items-baseline text-gray-900">
                <span class="text-3xl font-semibold">$</span>
