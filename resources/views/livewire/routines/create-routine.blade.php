        ...
        <x-slot name="content">
            <form wire:submit.prevent="save">
                ...
                <div class="mb-4">
                    ...
                    <select class="modal-select" wire:model="level" required>
                ...
                <div class="mb-4">
                    ...
                    <x-input type="number" wire:model="duration" required></x-input>
                ...
                <div>
                        ...
                        <div class="mb-4">
                            <div class="mb-4 flex flex-row items-center">
                                <div class="flex flex-col w-1/3 pr-4">
                                    ...
                                    <select wire:model="exercisesArray.{{ $key }}.exercise_id"
                                ...
                                <div class="flex flex-col w-1/3 pr-4">
                                    ...
                                    <x-input type="number" wire:model="exercisesArray.{{ $key }}.sets"
                                        required min="0" required></x-input>
                                    <x-input-error :for="'exercisesArray.' . $key . '.sets'"></x-input-error>
                                </div>
                                <div class="flex flex-col w-1/3">
                                    <x-label for="reps">Repeticiones</x-label>
                                    <x-input type="text" wire:model="exercisesArray.{{ $key }}.reps"
                                        required min="0"></x-input>
                    ...
                    <div class="mb-4">
                        <span class="cursor-pointer text-orange-500 font-semibold" wire:click="addExercise">Agregar
                            ejercicio</span>
                    </div>
                </div>
        </x-slot>
