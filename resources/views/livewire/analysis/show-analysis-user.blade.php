                     ...
                     <div class="overflow-x-auto">
                         @if (count($userAnalysis))                        
                                     ...
                                     @foreach ($userAnalysis as $item)
                                         {{-- @foreach ($item->memberships as $membership) --}}
                                             <tr class="border-b dark:border-gray-700">
                                                 ...
                                                 <td class="px-4 py-3">
                                                     <span class="px-2 py-1 font-semibold leading-tight"</td>
                                                     </span>
                            ...
                            @if ($userAnalysis->hasPages())
                                <div class="px-6 py-3">
                                    {{ $userAnalysis->links() }} {{-- Mostramos la paginación --}}
                                </div>
                             @endif
                         </div>
                         @else
