                                ...
                                <tbody>
                                    @foreach ($prs as $item)    
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td class="px-6 py-4">
                                                <a href="{{route('miProgreso', $item->exercise)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Ver progreso</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
