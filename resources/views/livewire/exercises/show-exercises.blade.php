            ...
            <section class="bg-white dark:bg-gray-900 antialiased">
                <div class="max-w-screen-xl px-4 py-4 mx-auto lg:px-16 sm:py-4 lg:py-4">
                    <div class="grid grid-cols-8 gap-x-12">
                                  ...
                                  <div class="overflow-x-auto">
                                    @if (count($exercises))                        
                                        ...
                                        @if ($exercises->hasPages())
                                                <div class="px-6 py-3">
                                                    {{ $exercises->links('vendor.pagination.tailwind') }} {{-- Mostramos la paginación --}}
                                                </div>
                                        @endif
                                </div>
                                @endif
                        ...
                        @if ($showExercise)
                        <div class="hidden md:grid md:col-span-3 md:place-content-between">  
                            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                    <img class="rounded-t-lg h-52 w-full" src="{{ asset(Storage::url($exercise->media)) }}" alt="Imagen Ejercicio" />
                                    <div class="px-5 pb-3">
                                        <div class="mt-3">
